...
В случае линейно неразделимой выборки мы ослабляем ограничения, тем самым позволяя алгоритму допускать ошибки, число которых мы минимизируем. В следствии этих действий задача квадратичного программирования принимают следующий вид:
